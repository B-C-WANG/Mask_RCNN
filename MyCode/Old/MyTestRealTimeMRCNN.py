...
if __name__ == '__main__':
    ...
    # TODO: the tensorflow should work in main thread, and the matplotlib show also need in main thread, so
# decided to  use the id, the memory address to get, and run two files
    # #test()
    # temp = RealTimeMaskRCNN()
    # print(1)
    # #thread2 = Thread(target=temp.thread_get_camera_image)
    #
    # thread1 = Thread(target=temp.thread_run_time_show)
    # thread1.start()
    # temp.thread_get_camera_image()
    #
    # #thread1.start()
    test()